...
# save selected_residues.pdb, surface_residues
...
# select surface_residues, byres (s. expand 10 and surface)



# SIXYSY_FILE = '/Users/yitongtseo/Documents/GitHub/ethical_necromancy/nanobody_design_scratch/myosin_2_pdb_files/6ysy_just_myosin.pdb'

# # Connect to PyMOL
# with pymol2.PyMOL() as pymol:
#     pymol.start()
#     # Load protein structure
#     pymol.cmd.load(SIXYSY_FILE, 'myosin')
    
#     # Calculate surface
#     # pymol.cmd.show_as('surface', 'myosin')
    
#     # # Select residues based on surface accessibility
#     # pymol.cmd.select('surface_residues', 'byres (s. expand 10 and surface)')
    
#     # # Show selected residues in the PyMOL viewer
#     # pymol.cmd.show('sticks', 'surface_residues')
    
#     # # Save selected residues to a file
#     # pymol.cmd.save('selected_residues.pdb', 'surface_residues')
